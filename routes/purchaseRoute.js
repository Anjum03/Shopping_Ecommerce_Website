...
//     const orderCount = await Purchase.countDocuments((count) => count)

//     if (!orderCount) {
//       res.status(500).json({ success: false, message: `Order Coun not Found....` })
//     }

//     res.status(200).json({ success: true, message: `All Count `, data: orderCount })
